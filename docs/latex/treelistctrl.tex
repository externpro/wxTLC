%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Name:        treelistctrl.tex
%% Purpose:     wxTreeListCtrl documentation
%% Author:      Otto Wyss
%% Modified by:
%% Created:     25.4.2004
%% RCS-ID:      $Id: treelistctrl.tex,v 1.16 2005/10/01 10:16:19 wyo Exp $
...
\membersection{wxTreeListCtrl::DeleteRoot}\label{wxtreelistctrldeleteroot}

\func{void}{DeleteRoot}{\void}

Deletes the root node of the tree and all its children.

\membersection{wxTreeListCtrl::EditableColumn}\label{wxtreelistctrleditablecolumn}

\func{void}{EditableColumn}{\param{int}{ column}, \param{bool}{ edit}}
...
\membersection{wxTreeListCtrl::FindItem}\label{wxtreelistctrlfinditem}

\func{wxTreeItemId}{FindItem}{\param{const wxTreeItemId\&}{ item}, \param{const wxString\&}{ str},
 \param{int}{flags=0}}
...
\twocolwidtha{5cm}
\begin{twocollist}\itemsep=0pt
\twocolitem{wxTL\_MODE\_NAV\_FULLTREE}{Searches within the full tree (default).}
\twocolitem{wxTL\_MODE\_NAV\_EXPANDED}{Searches within the expanded tree.}
\twocolitem{wxTL\_MODE\_NAV\_VISIBLE}{Searches within all visible items.}
\twocolitem{wxTL\_MODE\_NAV\_LEVEL}{Searches within only the current level.}
\end{twocollist}
\twocolwidtha{5cm}
\twocolitem{wxTL\_MODE\_FIND\_EXACT}{Matches exact up to the submitted text length (default).}
\twocolitem{wxTL\_MODE\_FIND\_PARTIAL}{Matches only partial up to the submitted text length.}
\twocolitem{wxTL\_MODE\_FIND\_NOCASE}{Matches case insensitive.}
\end{twocollist}
...
\constfunc{size_t}{GetChildrenCount}{\param{const wxTreeItemId\&}{ item}, \param{bool}{ recursively = true}}
...
\membersection{wxTreeListCtrl::GetFirstExpandedItem}\label{wxtreelistctrlgetfirstexpandeditem}

\constfunc{wxTreeItemId}{GetFirstExpandedItem}{\void}
...
\constfunc{int}{GetItemImage}{\param{const wxTreeItemId\&}{ item}, \param{int}{ column},
 \param{wxTreeItemIcon}{ which = wxTreeItemIcon_Normal}}
...
\constfunc{wxString}{GetItemText}{\param{const wxTreeItemId\&}{ item}, \param{int}{ column}}
...
\membersection{wxTreeListCtrl::GetLastChild}\label{wxtreelistctrlgetfirstchild}

\constfunc{wxTreeItemId}{GetLastChild}{\param{const wxTreeItemId\&}{ item}, \param{long\& }{cookie}}
...
\helpref{wxTreeListCtrl::GetPrevChild}{wxtreelistctrlgetprevchild}
...
\membersection{wxTreeListCtrl::GetNextExpanded}\label{wxtreelistctrlgetnextexpanded}

\constfunc{wxTreeItemId}{GetNextExpanded}{\param{const wxTreeItemId\&}{ item}}
...
\membersection{wxTreeListCtrl::GetPrevChild}\label{wxtreelistctrlgetprevchild}

\constfunc{wxTreeItemId}{GetPrevChild}{\param{const wxTreeItemId\&}{ item}, \param{long\& }{cookie}}
...
to make these functions reentrant (i.e. allow more than one
enumeration on one and the same object simultaneously). The cookie passed to
GetFirstChild,GetNextChild and GetPrevChild should be the same.
...
\membersection{wxTreeListCtrl::GetPrevExpanded}\label{wxtreelistctrlgetprevexpanded}

\constfunc{wxTreeItemId}{GetPrevExpanded}{\param{const wxTreeItemId\&}{ item}}
...
\constfunc{size_t}{GetSelections}{\param{wxArrayTreeItemIds\& }{selection}}
...
\func{wxTreeItemId}{InsertItem}{\param{const wxTreeItemId\& }{parent}, \param{size_t}{ index}, \param{const wxString\&}{ text},
 \param{int}{ image = -1}, \param{int}{ selImage = -1}, \param{wxTreeItemData*}{ data = NULL}}
...
\membersection{wxTreeListCtrl::SetDragItem}\label{wxtreelistctrlsetdragitem}

\func{void}{SetDragItem}{\param{const wxTreeItemId\&}{ item = (wxTreeItemId*)NULL}}
...
\func{bool}{SelectItem}{\param{const wxTreeItemId\&}{ item},
 \param{const wxTreeItemId\&}{ last} = (wxTreeItemId*)NULL,
 \param{bool}{ unselect_others = true}}
...
\func{void}{SetItemImage}{\param{const wxTreeItemId\&}{ item}, \param{int}{ column}, \param{int}{ image},
 \param{wxTreeItemIcon}{ which = wxTreeItemIcon_Normal}}
...
\func{void}{SetItemText}{\param{const wxTreeItemId\&}{ item}, \param{int}{ column}, \param{const wxString\&}{ text}}
...
\func{void}{AddColumn}{\param{const wxString\&}{ text}, \param{int}{ width}, \param{int}{ flag = wxALIGN_LEFT}}
...
\func{wxTreeListColumnInfo\&}{GetColumn}{\param{int}{ column}}

\constfunc{wxTreeListColumnInfo\&}{GetColumn}{\param{int}{ column}}

Returns the infos of the columns.

\membersection{wxTreeListCtrl::GetColumnAlignment}\label{wxtreelistctrlgetcolumnalignment}

\constfunc{int}{GetColumnAlignment}{\param{int}{ column}}
